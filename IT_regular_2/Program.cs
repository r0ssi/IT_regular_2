...
namespace IT_regular_2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nЗадача 4. Создать регулярное выражение, которому должно соответствовать слово МАЛИНА, " +
                "только если оно находится в самом начале испытуемого текста.");
            ...
            Console.WriteLine("\nЗадача 5. Создать регулярное выражение, которому должно соответствовать слово МАЛИНА, " +
                "только если оно находится в самом конце испытуемого текста.");
            ...
            Console.WriteLine("\nЗадача 8. Создать регулярное выражение, которому соответствовало бы слово ВЕС в тексте, но которое" +
                " не находило бы соответствие внутри слов (например, весы, весовщик).");
            ...
            Console.WriteLine("\nЗадача 9. Создать регулярное выражение, которому соответствовало бы символ слова ВЕС в тексте, " +
                "но которое не находило бы соответствие слова ВЕС.");
